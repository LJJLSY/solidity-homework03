...
const AMIN_PRIVATE_KEY = process.env.SEPOLIA_PRIVATE_KEY_1 || "";
const SELLER_PRIVATE_KEY = process.env.SEPOLIA_PRIVATE_KEY_2 || "";
const BIDDER_PRIVATE_KEY = process.env.SEPOLIA_PRIVATE_KEY_3 || "";

const oracleaddress = "0xd7Ac8AF96d71E0F5f7b489d3aA1A7F9484099a66";
const nftaddress = "0x0Dea90663b061eB523F0a955d5c33D3AF406697F";
const paymenttoken = "0x51fBd72668cF2dc4ebFe031A1F4A3aF5D11a8714";
...
async function main() { 
    ...
    console.log("出价...");
    const bidamount = ethers.parseEther("0.001");
